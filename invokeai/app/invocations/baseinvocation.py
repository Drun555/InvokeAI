...
RESERVED_FIELD_NAMES = {"id", "type", "is_intermediate", "use_cache", "workflow"}
...
def InputField(
    ...
    # because we are manually making fields optional, we need to store the original required bool
...
class BaseInvocationOutput(BaseModel):
    ...
    model_config = ConfigDict(
        validate_assignment=True, json_schema_serialization_defaults_required=True, json_schema_extra=json_schema_extra
    )
